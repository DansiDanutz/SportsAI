...
export function Layout({ children }: LayoutProps) {
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/accumulators', label: 'Accumulators', icon: AccumulatorsIcon },
    { path: '/strategy', label: 'Strategy & Bankroll', icon: StrategyIcon },
    ...
    { path: '/status', label: 'System Status', icon: SettingsIcon },
    // Premium-only items
...
function AccumulatorsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
